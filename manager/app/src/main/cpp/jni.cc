...
Java_com_thefloresto_jksu_Natives_becomeManager(JNIEnv *env, jobject, jstring pkg) {
...
Java_com_thefloresto_jksu_Natives_getVersion(JNIEnv *env, jobject) {
    return get_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_thefloresto_jksu_Natives_getManagerUid(JNIEnv *env, jobject) {
...
Java_com_thefloresto_jksu_Natives_getHookMode(JNIEnv *env, jobject) {
...
Java_com_thefloresto_jksu_Natives_getAllowList(JNIEnv *env, jobject) {
    int uids[1024];
    int size = 0;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}
...
Java_com_thefloresto_jksu_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("com/rifsxd/ksunext/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_su_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_thefloresto_jksu_Natives_isZygiskEnabled(JNIEnv *env, jobject) {
